                ...
                <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="user_id" name="user_id" value="{{ old('user_id', 'admin') }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm transition-shadow" placeholder="admin" required autofocus>
                        </div>
                    </div>
