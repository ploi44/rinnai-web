...
<div class="goback">
        ...
        <div class="mem_itv_section">
            <div class="mem_name">경영지원본부 정보System부 - 김응규 수석</div>
            <div class="mem_tit">IT부서가 기업혁신을 선도하는 핵심 부서라는 것은 모두 잘 알고 계실 것이라 생각합니다.</div>
            <div class="m_itv_area">
                <div class="photo"><img src="/assets/career/images/img_m_itvphoto_20.png?v=002" alt="직원사진" ></div>
                <div class="text_area_1">
                    <div class="t_qus">자기소개 및 본인의 직무를 소개해주세요.</div>
                    <div class="t_ans">
                        안녕하세요. 정보System부에서 근무하고 있는 김응규 수석입니다. 2003년에 입사해 어느덧 햇수로만 20년째 근무하고 있네요~ IT 기술력에 있어서는 나름 베테랑 중에 한 명이라고 자부하고 있으며, 뒤돌아봤을 때 스스로 부끄럽지 않도록 성장을 위해 끊임없이 노력하고 있습니다. <br><br>
